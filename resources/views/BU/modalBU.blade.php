<div class="modal fade col-sm-12" id="myModaledit{{ $Bu->id }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" class="form" action="{{URL('BUs/update/'.$Bu->id)}}">
                    @csrf
                    @method('put')
                    ...
                    <div class="row">
                        <div class="col-sm-6 form-group">
                            ...
                            <input type="text" id="nameBu" name="nameBu" value="{{ $Bu->name }}" class="form-control"
                                placeholder="Informe o nome">
                        </div>

                        <div class="col-sm-6 form-group">
                            <label for="type">Tipo</label>
                            <select type="text" id="type" name="type" class="form-control" placeholder="Informe o tipo">
