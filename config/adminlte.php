...
return [
    ...
    'menu' => [
        ...
        [
            ...
            'can' => ['prevenda', 'gestor', 'financeiro', 'venda', 'admin'],
        ],
        [
            'text' => 'Pedidos',
            'url' => 'order',
        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    'url' => 'partNumbers',
                    'icon' => false,
                    'can' => ['prevenda', 'financeiro', 'gestor', 'admin'],
                ],
                [
                    'text' => 'BUs',
                    'url' => 'BUs',
                    'icon' => false,
                    'can' => ['prevenda', 'gestor', 'venda', 'admin'],
                ],
                [
                    'text' => 'Familia',
                    'url' => 'Familia',
                    'icon' => false,
                    'can' => ['prevenda', 'gestor', 'admin'],
                ],
                [
                    'text' => 'Grupo',
                    'url' => 'groups',
        ...
        [
            ...
            'can' => ['prevenda', 'financeiro', 'gestor', 'venda', 'admin'],
            'submenu' => [
                [
                    'text' => 'Pendentes',
                    'url' => 'psc-pendente',
